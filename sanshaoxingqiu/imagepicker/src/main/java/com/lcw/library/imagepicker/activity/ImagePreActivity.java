...
public class ImagePreActivity extends BaseActivity {
    ...
    private void updateCommitButton() {
        ...
        if (selectCount < maxCount) {
            ...
            mTvCommit.setText(String.format(getString(R.string.confirm_msg1), selectCount, maxCount));
            return;
        }
        if (selectCount == maxCount) {
            mTvCommit.setEnabled(true);
    ...
    private void updateSelectButton(String imagePath) {
        ...
        if (isSelect) {
            mIvPreCheck.setImageDrawable(getResources().getDrawable(R.mipmap.icon_album_select_yes));
        } else {
            mIvPreCheck.setImageDrawable(getResources().getDrawable(R.mipmap.icon_album_select_no));
        }
    }
