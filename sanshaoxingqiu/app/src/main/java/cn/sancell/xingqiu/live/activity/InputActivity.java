...
import cn.sancell.xingqiu.live.base.BaseActivity;
...
public class InputActivity extends BaseActivity {
    ...
    public static void startActivityForResult(Fragment mFragment, String text, InputConfig inputConfig, InputActivityProxy proxy) {
        InputActivityProxyManager.getInstance().setProxy(proxy);

        Intent intent = new Intent();
        intent.putExtra(EXTRA_TEXT, text);
        intent.putExtra(EXTRA_INPUT_CONFIG, inputConfig);
        intent.setClass(mFragment.getContext(), InputActivity.class);
        mFragment.startActivityForResult(intent, REQ_CODE);
    }
...
//        //设置状态栏透明
    ...
    private void findViews() {
        ...
        MoonUtil.identifyFaceExpression(LiveCache.getContext(), messageEditText, text, ImageSpan.ALIGN_BOTTOM);
