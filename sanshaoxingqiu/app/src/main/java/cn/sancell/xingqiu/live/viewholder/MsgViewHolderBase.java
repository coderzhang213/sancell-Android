...
public abstract class MsgViewHolderBase extends TViewHolder {
    ...
    protected final int getResId() {
        return com.netease.nim.uikit.R.layout.nim_live_message_item;
    }
    ...
    protected final void inflate() {
        ...
        readReceiptTextView = findView(com.netease.nim.uikit.R.id.textViewAlreadyRead);
    ...
    private void setOnClickListener() {
        ...
        onClickListener = new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getAdapter().getEventListener().onMessageClick(message);
            }
        };
...
//        }
    ...
    public void setNameTextView() {
        if (message.getSessionType() == SessionTypeEnum.Team && isReceivedMessage() && !isMiddleItem()) {
            ...
            nameTextView.setText(SuperTeamHelper.getTeamMemberDisplayNameYou(message.getSessionId(), message
                    .getFromAccount()));
        } else {
