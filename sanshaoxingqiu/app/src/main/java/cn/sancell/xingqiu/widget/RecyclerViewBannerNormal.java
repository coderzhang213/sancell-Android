...
import cn.sancell.xingqiu.homepage.adapter.HomePageBannerAdapter;

public class RecyclerViewBannerNormal extends RecyclerViewBannerBase<LinearLayoutManager, HomePageBannerAdapter> {
    ...
    @Override
    protected HomePageBannerAdapter getAdapter(Context context, List<String> list, OnBannerItemClickListener onBannerItemClickListener) {
        return new HomePageBannerAdapter(context, list,onBannerItemClickListener);
    }
