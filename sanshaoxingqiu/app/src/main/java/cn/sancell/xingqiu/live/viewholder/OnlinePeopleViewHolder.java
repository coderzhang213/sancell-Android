...
import cn.sancell.xingqiu.live.widget.ChatRoomImageView;
...
public class OnlinePeopleViewHolder extends TViewHolder {
    ...
    protected void refresh(Object item) {
        ...
        if (chatRoomMember.getMemberType() == MemberType.CREATOR) {
            ...
            identityImage.setImageDrawable(context.getResources().getDrawable(R.mipmap.master_icon));
        } else if (chatRoomMember.getMemberType() == MemberType.ADMIN) {
            identityImage.setVisibility(View.VISIBLE);
            identityImage.setImageDrawable(context.getResources().getDrawable(R.mipmap.admin_icon));
        } else {
