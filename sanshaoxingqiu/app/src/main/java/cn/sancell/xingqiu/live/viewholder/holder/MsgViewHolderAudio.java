...
import cn.sancell.xingqiu.live.session.MessageAudioControl;
...
public class MsgViewHolderAudio extends MsgViewHolderBase {
    ...
    private void layoutByDirection() {
        if (isReceivedMessage()) {
            ...
            containerView.setBackgroundResource(com.netease.nim.uikit.R.drawable.nim_message_item_left_selector);
            ...
            containerView.setBackgroundResource(com.netease.nim.uikit.R.drawable.nim_message_item_right_selector);
