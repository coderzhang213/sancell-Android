 ...
 * ━━━━━━━━━━━神兽出没━━━━━━━━━━━━━━
 */
public class TownAdapter extends BaseQuickAdapter<AddressBean.CityBean.AreaBean.TownBean, BaseViewHolder> {
    public TownAdapter(int layoutResId, @Nullable List<AddressBean.CityBean.AreaBean.TownBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, AddressBean.CityBean.AreaBean.TownBean item) {
