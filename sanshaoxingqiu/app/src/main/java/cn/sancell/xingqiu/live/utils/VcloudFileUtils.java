...
import cn.sancell.xingqiu.live.nim.CapturePreviewController;
import cn.sancell.xingqiu.live.nim.MediaCaptureWrapper;
...
public class VcloudFileUtils {
    ...
    public static void sendUpdateBroadcast(String screenShotFilePath) {
        ...
        intent.setData(uri);
        LiveCache.getContext().sendBroadcast(intent);//这个广播的目的就是更新图库，发了这个广播进入相册就可以找到你保存的图片了！，记得要传你更新的file哦
    }
