...
public final class RoundedTransformationBuilder {
  ...
  public RoundedTransformationBuilder cornerRadius(float radius) {
    mCornerRadii[RoundedDrawable.CORNER_TOP_LEFT] = radius;
    mCornerRadii[RoundedDrawable.CORNER_TOP_RIGHT] = radius;
    mCornerRadii[RoundedDrawable.CORNER_BOTTOM_RIGHT] = radius;
    mCornerRadii[RoundedDrawable.CORNER_BOTTOM_LEFT] = radius;
    return this;
  }
