...
import cn.sancell.xingqiu.interfaces.CallBack;
import cn.sancell.xingqiu.startup.adapter.GuideAdapter;
    ...
    public void onPageSelected(int i) {
        ...
        if (callBack != null) {
            ...
            if (i == pageSize - 1) {
                ...
                pointContent.setVisibility(GONE);
                callBack.callSlidingLast();
            }else {
                pointContent.setVisibility(VISIBLE);
            }
        }
    }
