package cn.sancell.xingqiu.live.network;
...
import cn.sancell.xingqiu.live.http.DemoServerHttpClient;
...
public class NetworkUtils {
    ...
    public static int getNetworkType(){
        ConnectivityManager connMgr = (ConnectivityManager) LiveCache.getContext()
