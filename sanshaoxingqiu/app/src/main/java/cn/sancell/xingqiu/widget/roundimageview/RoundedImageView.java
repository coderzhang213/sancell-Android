...
public class RoundedImageView extends AppCompatImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundedImageViewEach, defStyle, 0);

        int index = a.getInt(R.styleable.RoundedImageViewEach_android_scaleType,-1);
        if (index >= 0) {
        ...
        float cornerRadiusOverride =
                a.getDimensionPixelSize(R.styleable.RoundedImageViewEach_riv_corner_radius_each, -1);

        mCornerRadii[RoundedDrawable.CORNER_TOP_LEFT] = a.getDimensionPixelSize(R.styleable.RoundedImageViewEach_riv_corner_radius_top_left, -1);
        mCornerRadii[RoundedDrawable.CORNER_TOP_RIGHT] = a.getDimensionPixelSize(R.styleable.RoundedImageViewEach_riv_corner_radius_top_right, -1);
        mCornerRadii[RoundedDrawable.CORNER_BOTTOM_RIGHT] = a.getDimensionPixelSize(R.styleable.RoundedImageViewEach_riv_corner_radius_bottom_right, -1);
        mCornerRadii[RoundedDrawable.CORNER_BOTTOM_LEFT] = a.getDimensionPixelSize(R.styleable.RoundedImageViewEach_riv_corner_radius_bottom_left, -1);
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageViewEach_riv_border_width_each, -1);
        if (mBorderWidth < 0) {
            mBorderWidth = DEFAULT_BORDER_WIDTH;
        }

        mBorderColor = a.getColorStateList(R.styleable.RoundedImageViewEach_riv_border_color_each);
        if (mBorderColor == null) {
            mBorderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
        }

        mMutateBackground = a.getBoolean(R.styleable.RoundedImageViewEach_riv_mutate_background_each, false);
        mIsOval = a.getBoolean(R.styleable.RoundedImageViewEach_riv_oval_each, false);

        final int tileMode = a.getInt(R.styleable.RoundedImageViewEach_riv_tile_mode_each, TILE_MODE_UNDEFINED);
        ...
        final int tileModeX =
                a.getInt(R.styleable.RoundedImageViewEach_riv_tile_mode_each, TILE_MODE_UNDEFINED);
        if (tileModeX != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileModeX));
        }

        final int tileModeY =
                a.getInt(R.styleable.RoundedImageViewEach_riv_tile_mode_y_each, TILE_MODE_UNDEFINED);
