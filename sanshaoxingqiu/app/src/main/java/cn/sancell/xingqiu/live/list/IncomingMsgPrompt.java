package cn.sancell.xingqiu.live.list;
...
public class IncomingMsgPrompt {
    ...
    // 初始化底部新信息提示条
    private void init() {
        ViewGroup containerView = (ViewGroup) view.findViewById(com.netease.nim.uikit.R.id.message_activity_list_view_container);
        View.inflate(context, com.netease.nim.uikit.R.layout.nim_new_message_tip_layout, containerView);
        newMessageTipLayout = containerView.findViewById(com.netease.nim.uikit.R.id.new_message_tip_layout);
        ...
        newMessageTipTextView = (TextView) newMessageTipLayout.findViewById(com.netease.nim.uikit.R.id.new_message_tip_text_view);
        newMessageTipHeadImageView = (HeadImageView) newMessageTipLayout.findViewById(com.netease.nim.uikit.R.id.new_message_tip_head_image_view);
    }
