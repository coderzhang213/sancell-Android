package cn.sancell.xingqiu.picker;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected int cancelTextColor = 0xFFB1B3B1;
    protected int submitTextColor = 0xFF0F9954;
    protected int titleTextColor = Color.BLACK;
    protected int cancelPressedTextColor = 0xFF656665;
    protected int submitPressedTextColor = 0xFF067342;
     ...
     * 设置按下时的文字颜色
     */
    public void setcancelPressedTextColor(int pressedTextColor) {
        this.cancelPressedTextColor = pressedTextColor;
    }

    /**
     * 设置按下时的文字颜色
     */
    public void setSubmitPressedTextColor(int pressedTextColor) {
        this.submitPressedTextColor = pressedTextColor;
    }
    ...
    protected final View makeContentView() {
        ...
        if (contentLeftAndRightPadding > 0) {
            lr = ScreenUtils.dip2px(activity, contentLeftAndRightPadding);
        }
        if (contentTopAndBottomPadding > 0) {
            tb = ScreenUtils.dip2px(activity, contentTopAndBottomPadding);
        }
    ...
    protected View makeHeaderView() {
        ...
        int height = ScreenUtils.dip2px(activity, topHeight);
        ...
        int padding = ScreenUtils.dip2px(activity, topPadding);
        cancelButton.setPadding(padding, 0, padding, 0);
        if (!TextUtils.isEmpty(cancelText)) {
            cancelButton.setText(cancelText);
        }
        cancelButton.setTextColor(ScreenUtils.toColorStateList(cancelTextColor, cancelPressedTextColor));
        if (cancelTextSize != 0) {
        ...
        if (null == titleView) {
            ...
            int margin = ScreenUtils.dip2px(activity, topPadding);
        ...
        submitButton.setTextColor(ScreenUtils.toColorStateList(submitTextColor, submitPressedTextColor));
        if (submitTextSize != 0) {
