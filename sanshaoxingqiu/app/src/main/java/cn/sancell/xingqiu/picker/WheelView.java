...
public class WheelView extends View {
    ...
    public static final int TEXT_COLOR_FOCUS = 0XFF0F9954;
    public static final int TEXT_COLOR_NORMAL = 0XFFB1B3B1;
    public static final int DIVIDER_COLOR = 0XFF0F9954;
    ...
    public void setTextPadding(int textPadding) {
        this.textPadding = ScreenUtils.dip2px(getContext(), textPadding);
    }
    ...
    private void remeasure() {
        ...
        if (useWeight) {
            ...
            if (textPadding < 0) {
                textPadding = ScreenUtils.dip2px(getContext(), ITEM_PADDING);
            }
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER://显示内容居中
                ...
                break;
            case Gravity.LEFT:
                drawCenterContentStart = ScreenUtils.dip2px(getContext(), 8);
                break;
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (gravity) {
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawOutContentStart = ScreenUtils.dip2px(getContext(), 8);
                break;
            case Gravity.RIGHT:
