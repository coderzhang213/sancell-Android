package cn.sancell.xingqiu.im.manager;
...
import cn.sancell.xingqiu.im.event.EventFilter;
import cn.sancell.xingqiu.im.event.NetStateCode;
import cn.sancell.xingqiu.im.event.OnlineState;
import cn.sancell.xingqiu.im.event.OnlineStateCode;
import cn.sancell.xingqiu.im.event.OnlineStateEventCache;
import cn.sancell.xingqiu.im.event.OnlineStateEventConfig;
import cn.sancell.xingqiu.im.event.OnlineStateEventSubscribe;
...
public class OnlineStateEventManager {
    ...
    private static void registerNetTypeChangeObserver() {
        ...
        ImCache.getContext().registerReceiver(receiver, filter);
    }
    ...
    public static void publishOnlineStateEvent(boolean force) {
        ...
        int netState = getNetWorkTypeName(ImCache.getContext());
    ...
    private static boolean enableOnlineStateEvent() {
        String packageName = ImCache.getContext().getPackageName();
