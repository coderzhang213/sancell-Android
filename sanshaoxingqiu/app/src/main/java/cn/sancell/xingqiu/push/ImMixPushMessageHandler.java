package cn.sancell.xingqiu.push;
...
public class ImMixPushMessageHandler implements MixPushMessageHandler {
    ...
    public boolean onNotificationClicked(Context context, Map<String, String> payload) {
        ...
        LogUtil.i(ImMixPushMessageHandler.class.getSimpleName(), "rev pushMessage payload " + payload);
    ...
    private ComponentName initLaunchComponent(Context context) {
        ...
        StatusBarNotificationConfig config = ImCache.getNotificationConfig();
