package cn.sancell.xingqiu.im.ui.sysMsg;
...
public class SystemMessageActivity extends UI implements TAdapterDelegate,
    ...
    private void onSystemNotificationDeal(final SystemMessage message, final boolean pass) {
        ...
        } else if (message.getType() == SystemMessageType.ApplyJoinTeam) { //验证入群
            if (pass) {
                ScClient.passApply(this,message.getTargetId(),message.getFromAccount(),callback);
