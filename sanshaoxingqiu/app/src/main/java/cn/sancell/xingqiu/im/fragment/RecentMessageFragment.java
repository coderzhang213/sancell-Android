...
import cn.sancell.xingqiu.im.ui.recent.RecentMsgPresenter;
import cn.sancell.xingqiu.im.ui.recent.RecentMsgView;
 ...
 */
public class RecentMessageFragment extends BaseNotDataFragment<RecentMsgPresenter> implements RecentMsgView {
    ...
    protected RecentMsgPresenter createPresenter() {
        return new RecentMsgPresenter(getContext());
    }
                    ...
                    new RequestCallbackWrapper<List<RecentContact>>() {
                        ...
                        public void onResult(int code, List<RecentContact> recents, Throwable exception) {
                            ...
                            for (int i= 0;i < recents.size();i++) {
                                if (recents.get(i).getMsgType() == MsgTypeEnum.custom) {
                                    recents.remove(i);
                                    i--;
                                }
                            }
