...
public class SancellClassicsHeader extends LinearLayout implements RefreshHeader {
    private TextView mHeaderText;//标题文本
    private ImageView mProgressView;//刷新动画视图
    //private ProgressDrawable mProgressDrawable;//刷新动画

    public SancellClassicsHeader(Context context) {
        this(context, null);
    }

    public SancellClassicsHeader(Context context, AttributeSet attrs) {
        super(context, attrs, 0);
        setGravity(Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM);
        setOrientation(VERTICAL);
        setPadding(0, SmartUtil.dp2px(24) + ScreenUtils.getStatusBarHeight(context), 0, SmartUtil.dp2px(12));
        ...
        setMinimumHeight(SmartUtil.dp2px(79) + ScreenUtils.getStatusBarHeight(context));
    }
