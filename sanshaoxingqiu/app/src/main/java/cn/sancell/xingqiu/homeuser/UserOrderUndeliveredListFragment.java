...
public class UserOrderUndeliveredListFragment extends BaseLazyMVPFragment<UserOrderListContract.OrderListFragmentPresenter>
    ...
    public void netWorkError() {
        ...
        tv_refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //   mPresenter.GetOrderUndeliveredList(1, getActivity());
...
//                                    }
//                                }
                                GoodsDetailActivity.start(getContext(), Integer.parseInt(data_productid.get(0)));
    ...
    @Override
    public void getOrderDeliveredListSuccess(List<OrderAllListNoPayListDataBean> data,
                                             int page, int totalCount) {

    }

    @Override
    public void getOrderFinishedListSuccess(List<OrderAllListNoPayListDataBean> data,
                                            int page, int totalCount) {
    ...
    protected View initViews(LayoutInflater inflater, ViewGroup container, Bundle
        ...
        refreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(@NonNull RefreshLayout refreshLayout) {
                if (orderListAdapter != null) {
                    //   mPresenter.GetOrderUndeliveredList(orderListAdapter.getNextPage(), getActivity());
