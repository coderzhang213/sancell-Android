...
public class DateUtils extends android.text.format.DateUtils {
    ...
    public static String getStrTime(String cc_time) {
        if (StringUtils.isTextEmpty(cc_time)) {
            return "";
        }
    ...
    // 将时间戳转为字符串
    public static String getYY_MM_DD(String cc_time) {
        if (StringUtils.isTextEmpty(cc_time)) {
            return "";
        }
        String re_StrTime = null;
    ...
    public static String getStrTime1F(String cc_time) {
        if(StringUtils.isTextEmpty(cc_time)){
            return "";
        }
        String re_StrTime = null;
    ...
    public static String getTimeByStamp(long timeStamp) {
        SimpleDateFormat sdf = new SimpleDateFormat("MM.dd HH:mm",Locale.PRC);
     ...
     * @return
     */
    public static String getTimeByStampWithYear(long timeStamp) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd",Locale.PRC);
        return sdf.format(new Date(timeStamp * 1000L));
    }

    public static String getTimeWithMonthDayHourMinute(long timeStamp){
        SimpleDateFormat sdf = new SimpleDateFormat("MM-dd HH:mm",Locale.PRC);
        return sdf.format(new Date(timeStamp * 1000L));
    }
}
