...
public interface ResetPwdFirstStepContract {
    interface ResetPwdFirstView extends BaseView {
    ...
    class ResetPwdFirstPresenter extends BasePresenter<ResetPwdFirstStepContract.ResetPwdFirstView> {
        /**
         * 检测短信验证码是否正确
         *
         * @param mobile
         * @param smsCode
         */
        public void ResetPwdFirst(String mobile, String smsCode, final Context context) {
            ...
            RetrofitUtil.getInstance().initRetrofit().checkCode(map)
