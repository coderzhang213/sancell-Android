 ...
 * 关注/粉丝列表
 */
class FocusAdapter(data: MutableList<LiverBean>) : BaseQuickAdapter<LiverBean, BaseViewHolder>(R.layout.recycle_live_liver, data) {
    ...
    override fun convert(helper: BaseViewHolder, item: LiverBean) {
    ...
    interface OnFocusListener {
        fun onFocus(position: Int, data: LiverBean)
        fun onItemClick(data: LiverBean)
    }
