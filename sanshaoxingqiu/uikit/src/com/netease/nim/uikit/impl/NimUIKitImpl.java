    ...
    */
    ...
    private static void initDefaultSessionCustomization() {
        ...
        if (recentCustomization == null) {
            recentCustomization = new DefaultRecentCustomization(); //修改消息提示
        }
    }
    ...
    public static void registerCustomViewHolder(Class<? extends MsgAttachment> attach,Class<? extends MsgViewHolderBase> viewHolder){
        MsgViewHolderFactory.register(attach,viewHolder);
    }
