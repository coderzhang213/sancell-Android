...
public class NimUIKit {
     ...
     * @param viewHolder
     */
    public static void registerCustomHolder(Class<? extends MsgAttachment> attach,Class<? extends MsgViewHolderBase> viewHolder){
        NimUIKitImpl.registerCustomViewHolder(attach,viewHolder);
    }
