...
import com.netease.nim.uikit.support.DarkBarUtils;
...
public class AdvancedTeamInfoActivity extends UI implements TAdapterDelegate, TeamMemberAdapter.AddMemberCallback,
    ...
    private void findViews() {
        ...
        teamHeadImage.setOnClickListener(v -> showSelector(R.string.set_head_image, REQUEST_PICK_ICON));
        teamNameText = findViewById(R.id.team_name);
        teamIdText = findViewById(R.id.team_id);
        teamIdText.setOnClickListener(v -> {
            StringUtil.copyText(this,teamIdText.getText().toString());
        });
        ...
        //不显示扩展
        layoutTeamExtension.setVisibility(View.GONE);
...
//                    new TeamMemberAdapter.TeamMemberItem(TeamMemberAdapter.TeamMemberItemTag.ADD, null, null, null));
    ...
    private void quitTeam() {
        ...
        NIMClient.getService(TeamService.class).quitTeam(teamId).setCallback(new RequestCallback<Void>() {
            ...
            public void onSuccess(Void param) {
                ...
                //重置公告通知
                UserPreferences.saveNotice(teamId,true);
                finish();
            }
    ...
    private void updateTeamNotifyText(TeamMessageNotifyTypeEnum typeEnum) {
       if (typeEnum == TeamMessageNotifyTypeEnum.Manager) {
