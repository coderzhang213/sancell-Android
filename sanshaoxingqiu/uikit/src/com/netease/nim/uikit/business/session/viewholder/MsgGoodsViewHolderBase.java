 ...
 */
public abstract class MsgGoodsViewHolderBase extends RecyclerViewHolder<BaseMultiItemFetchLoadAdapter, BaseViewHolder, IMMessage> {

    public MsgGoodsViewHolderBase(BaseMultiItemFetchLoadAdapter adapter) {
        super(adapter);
