...
import com.netease.nim.uikit.common.ui.UiConfig;
...
public class AdvancedTeamMemberInfoActivity extends UI implements View.OnClickListener {
    ...
    private void updateMemberInvitor() {
        if (viewMember.getInvitorAccid() == null) {
                    ...
                    new RequestCallbackWrapper<Map<String, String>>() {
                        ...
                        public void onResult(int code, Map<String, String> result, Throwable exception) {
                            if (code == ResponseCode.RES_SUCCESS && result != null) {
                                ...
                                if (invitor != null) {
                                    if (!TextUtils.isEmpty(invitor) && invitor.length() > UiConfig.IM_INVITE_NAME_LENGTH){
                                        invitorInfo.setText(new StringBuffer(invitor.substring(0,10)+"..."));
                                    }else{
            ...
            if (!TextUtils.isEmpty(viewMember.getInvitorAccid()) && viewMember.getInvitorAccid().length() > UiConfig.IM_INVITE_NAME_LENGTH){
                invitorInfo.setText(new StringBuffer(viewMember.getInvitorAccid().substring(0,10)+"..."));
            }else{
