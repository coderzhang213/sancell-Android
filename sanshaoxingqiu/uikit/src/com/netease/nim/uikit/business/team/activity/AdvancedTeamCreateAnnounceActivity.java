...
public class AdvancedTeamCreateAnnounceActivity extends UI {
    ...
    private void findViews() {
        ...
        teamAnnounceTitle.setFilters(new InputFilter[]{new InputFilter.LengthFilter(30)});
        teamAnnounceContent.setFilters(new InputFilter[]{new InputFilter.LengthFilter(30)});
        initListener();
    }
    ...
    public void initListener(){
        teamAnnounceTitle.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (!TextUtils.isEmpty(s.toString())&&s.toString().length() >= 30){
                    ToastHelper.showToast(AdvancedTeamCreateAnnounceActivity.this,"群公告不能超过30字");
                }
            }
        });
        teamAnnounceContent.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if (!TextUtils.isEmpty(s.toString())&&s.toString().length() >= 30){
                    ToastHelper.showToast(AdvancedTeamCreateAnnounceActivity.this,"群公告内容不能超过30字");
                }
            }
        });
    }
    ...
    private void updateAnnounce() {
        ...
        NIMClient.getService(TeamService.class).updateTeam(teamId, TeamFieldEnum.Announcement, announcement).setCallback(new RequestCallback<Void>() {
            ...
            public void onFailed(int code) {
                ...
                if (code == 802){
                    //权限问题
                    ToastHelper.showToast(AdvancedTeamCreateAnnounceActivity.this, "权限不足");
